      ...
      <form id="form1" name="form1" method="POST">
            <table width="50%" border="0" align="center">
              ...
              <tr>
                ...
                <th colspan="3" scope="col">MAKLUMAT PERALATAN</th>
              ...
              <tr>
               ...
               <tr>
                ...
                <td><span id="sprytextfield1">
                  <input name="Peralatan" type="text" class="text" id="Peralatan" value="<?php echo $row_rcd_EditInventory['Peralatan']; ?>" disabled="disabled" />
              ...
              <tr>
                ...
                <td><span id="sprytextfield4">
                  <input name="NoSiri" type="text" class="text" id="NoSiri" disabled="disabled" value="<?php echo $row_rcd_EditInventory['NoSiri']; ?>" /><br/>
              ...
              <tr>
                ...
                <td><span id="sprytextfield2">
                  <label>
                    <input name="Pengeluar" type="text" id="Pengeluar" disabled="disabled" value="<?php echo $row_rcd_EditInventory['Pengeluar']; ?>"  class="text" />
                    </label>
              ...
              <tr>
                ...
                <td><span id="sprytextfield3">
                  <label>
                    <input name="Model" type="text" id="Model" disabled="disabled" value="<?php echo $row_rcd_EditInventory['Model']; ?>"  class="text"/>
                    </label>
              ...
              <tr>
                ...
                <td><span id="sprytextarea1">
                  <label>
                    <textarea name="Spesifikasi" id="Spesifikasi" disabled="disabled" width="250"><?php echo $row_rcd_EditInventory['Spesifikasi']; ?></textarea>
                    </label>
              ...
              <tr>
                ...
                <td><strong>:</strong></td>
                <td>
                 <input type="radio" name="beliSewa" id="radioBeli" disabled="disabled" value="Beli" onClick="validateBeliSewa();"/>
                  Pembelian</label>
                  <input type="radio" name="beliSewa" id="radioSewa" disabled="disabled" value="Sewa" onClick="validateBeliSewa();"/>
                  Sewaan</td>
                </tr>
              <tr>
             ...
             <tr>
              ...
              <tr>
                ...
                <td><span id="spryselect3">
                  <select name="IdSyarikat" id="IdSyarikat"  disabled="disabled">
...
?>
              ...
              <tr>
                <td align="center"><input type="button" name="bck_bttn" id="bck_bttn" value="Back" class="button" onclick="parent.location='InventoryMain.php'"/></td>
                </tr>
            </table>
