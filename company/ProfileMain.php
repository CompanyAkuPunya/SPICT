...
if (isset($_SESSION['MM_Username'])) {
  $colname_rcd_Company = $_SESSION['MM_Username'];
}
mysql_select_db($database_dataconn, $dataconn);
$query_rcd_Company = sprintf("SELECT * FROM syarikat WHERE Username = %s", GetSQLValueString($colname_rcd_Company, "text"));
...
if(isset($_SESSION['IdCompany'])){
	$_SESSION['IdCompany']=$row_rcd_Company['Id'];
}
else{
	if (!isset($_SESSION)) {
  		session_start();
                  ...
                  <tr>
                    <td colspan="3" align="center"><table width="100%" align="center" id="formtable2">
                      ...
                      <tr>
                        ...
                        <td width="69%"><?php echo $row_rcd_Company['Nama']; ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Email']; ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact1_Nama']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>No. Tel. Pejabat</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact1_NoTel']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>No. Tel. Bimbit</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact1_NoHp']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>Email</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact1_Email']; ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><strong>Nama</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact2_Nama']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>No. Tel. Pejabat</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact2_NoTel']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>No. Tel. Bimbit</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact2_NoHp']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>Email</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact2_Email']; ?></td>
                      </tr> <tr>
                      ...
                      <tr>
                        <td><strong>Nama</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact3_Nama']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>No. Tel. Pejabat</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact3_NoTel']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>No. Tel. Bimbit</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact3_NoHp']; ?></td>
                      </tr>
                      <tr>
                        <td><strong>Email</strong></td>
                        <td><strong>:</strong></td>
                        <td><?php echo $row_rcd_Company['Contact3_Email']; ?></td>
                      </tr>
                      <tr>
                        <td colspan="3">&nbsp;</td>
                      </tr>
