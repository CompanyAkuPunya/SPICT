...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "/spict/staff/ProfileMain.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
if (isset($_SESSION['IdStaff'])) {
  $colname_rcd_EditStaf = $_SESSION['IdStaff'];
}
mysql_select_db($database_dataconn, $dataconn);
...
<span class="textfieldRequiredMsg">Sila Masukkan Poskod</span></span></td>
              ...
              <tr>
                <td align="center"><input type="submit" name="save_bttn" id="save_bttn" value="Save" class="button" />
                  <input type="button" name="bck_bttn" id="bck_bttn" value="Back" class="button" onclick="parent.location='ProfileMain.php'"/></td>
                </tr>
            </table>
