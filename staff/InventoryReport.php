...
?>
                  ...
                  <tr>
                    <td colspan="3"><input name="IdPeralatan" type="hidden" id="IdPeralatan" value="<?php echo $row_rcd_Inventory['Id']; ?>" /></td>
                    </tr>
                    <tr>
                    <td><strong>Tarikh Laporan</strong></td>
                    <td><strong>:</strong></td>
                    <td><span id="sprytextfield1">
                      <input type="text" name="TarikhLaporan" id="TarikhLaporan" class="text" />
                      <span class="textfieldRequiredMsg">Sila Masukkan Tarikh Kerosakan</span></span></td>
                    </tr>
                  <tr>
                    <td><strong>Jenis Kerosakan</strong></td>
                    <td><strong>:</strong></td>
                    <td><span id="spryselect1">
                      <select name="JenisKerosakan" id="JenisKerosakan">
                        <option value="-1">Sila Pilih Jenis Kerosakan</option>
                        <?php
do {  
?>
                        <option value="<?php echo $row_rcd_JenisKerosakan['Id']?>"><?php echo $row_rcd_JenisKerosakan['Keterangan']?></option>
                        <?php
...
?>
                  ...
                  <tr>
                    ...
                    <td><strong>:</strong></td>
                    <td>
                      <textarea name="KeteranganKerosakan" id="KeteranganKerosakan" cols="45" rows="5"></textarea>
                   </td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;<hr/>&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td><strong>:</strong></td>
                    <td>
                      <input type="text" name="TarikhSelenggara" id="TarikhSelenggara" class="text" disabled="disabled" />
                    </td>
                    </tr>
                  <tr>
                    ...
                    <td>
                      <select name="Status" id="Status" disabled="disabled">
                        <option value="-1">Sila Pilih Status</option>
                        <?php
do {  
?>
<option value="<?php echo $row_rcd_StatusSelenggara['Id']?>"><?php echo $row_rcd_StatusSelenggara['Keterangan']?></option>
                        <?php
...
?>
                    ...
                    <td><strong>:</strong></td>
                    <td>
                      <textarea name="NotaSelenggara" class="text" id="NotaSelenggara" disabled="disabled"></textarea>
                    </td>
                    </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
