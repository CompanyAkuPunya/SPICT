...
?>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield1">
                      <input name="TarikhLaporan" type="text" class="text" id="TarikhLaporan" value="<?php echo $row_rcd_Report['TarikhLaporan']; ?>" />
...
?>
                    ...
                    <tr>
                      ...
                      <td><span id="sprytextarea1">
                        <textarea name="KeteranganKerosakan" id="KeteranganKerosakan" cols="45" rows="5"><?php echo $row_rcd_Report['KeteranganKerosakan']; ?></textarea>
                    ...
                    <td><strong>:</strong></td>
                    <td><input name="TarikhSelenggara" type="text" class="text" id="TarikhSelenggara" 
                    value="<?php echo $row_rcd_Report['TarikhSelenggara']; ?>" />
                     </td>
                    </tr>
                  <tr>
...
?>
              ...
              <tr>
                ...
                <input type="button" name="email_bttn" id="email_bttn" value="Email" class="button"
                 onclick="parent.location='EmailMain.php?IdReport=<?php echo $row_rcd_Report['Id']; ?>'"/>
