...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "company/ProfileMain.php";
  $MM_redirectLoginFailed = "company_login.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_dataconn, $dataconn);
  
  $LoginRS__query=sprintf("SELECT Username, Password FROM syarikat WHERE Username=%s AND Password=%s",
          ...
          <form id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>"> 
            <table width="40%" id="formtable" >
              ...
              <tr>
                ...
                <td scope="col"  colspan="3" align="center"><strong>COMPANY LOGIN</strong><br /><br />
                  <span class="RED">
