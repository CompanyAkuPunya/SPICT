...
$maxRows_rcd_Branches = 20;
$pageNum_rcd_Branches = 0;
if (isset($_GET['pageNum_rcd_Branches'])) {
  $pageNum_rcd_Branches = $_GET['pageNum_rcd_Branches'];
}
...
if (isset($_GET['totalRows_rcd_Branches'])) {
  $totalRows_rcd_Branches = $_GET['totalRows_rcd_Branches'];
} else {
  $all_rcd_Branches = mysql_query($query_rcd_Branches);
  $totalRows_rcd_Branches = mysql_num_rows($all_rcd_Branches);
}
$totalPages_rcd_Branches = ceil($totalRows_rcd_Branches/$maxRows_rcd_Branches)-1;

$queryString_rcd_Branches = "";
if (!empty($_SERVER['QUERY_STRING'])) {
  $params = explode("&", $_SERVER['QUERY_STRING']);
  $newParams = array();
  foreach ($params as $param) {
    if (stristr($param, "pageNum_rcd_Branches") == false && 
        stristr($param, "totalRows_rcd_Branches") == false) {
      array_push($newParams, $param);
    }
  }
  if (count($newParams) != 0) {
    $queryString_rcd_Branches = "&" . htmlentities(implode("&", $newParams));
  }
}
$queryString_rcd_Branches = sprintf("&totalRows_rcd_Branches=%d%s", $totalRows_rcd_Branches, $queryString_rcd_Branches);
?>
      ...
      <tr>
        ...
        <form id="form1" name="form1" method="post" action="DataMain.php">
         <table width="90%" border="0" align="center">
           <tr>
                <td align="center"><h3>SENARAI CAWANGAN</h3></td>
              </tr>
              <tr>
                <td align="center">&nbsp;</tr>
               <tr>
              ...
              <tr>
                <td align="right"><a href="CawanganAdd.php"><img src="../images/add.gif" width="16" height="16" /> Tambah Cawangan</a></td>
              </tr>
          </table>
           ...
           <table width="90%" border="1" align="center"  id="newspaper-b">
              ...
              <th scope="col" align="center">Negeri</th>
                <th scope="col" align="center">Kod</th>
                <th scope="col" align="center">Cawangan</th>
                <th scope="col" align="center" width="50px">&nbsp;</th>
              </tr>
              </thead>
                <?php  $counter = ($startRow_rcd_Branches + 1);?>
                <?php do { ?>
                  <tr>
                    <td align="center"><?php echo $counter ?></td>
                    <td><?php echo $row_rcd_Branches['NamaNegeri']; ?></td>
                    <td><?php echo $row_rcd_Branches['Kod']; ?></td>
                    <td><?php echo $row_rcd_Branches['Keterangan']; ?></td>
                    <td align="center"><a href="CawanganEdit.php?Id=<?php echo $row_rcd_Branches['Id']; ?>">
                      <img src="../images/edit.png"  width="16" height="16" /></a></td>
                  </tr><?php $counter++; ?>
                  <?php } while ($row_rcd_Branches = mysql_fetch_assoc($rcd_Branches)); ?>
           </table>
 <p align="center" ><span class="px10">
 Rekod <?php echo ($startRow_rcd_Branches + 1) ?> 
 Hingga <?php echo min($startRow_rcd_Branches + $maxRows_rcd_Branches, $totalRows_rcd_Branches) ?> 
 Daripada <?php echo $totalRows_rcd_Branches ?> </span></p>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($rcd_Branches);
?>
