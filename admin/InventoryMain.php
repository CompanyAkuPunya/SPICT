...
if (isset($_POST['Search'])) {
$query_rcd_Inventory = sprintf("SELECT Id, Peralatan, Jenis, Pengeluar, Model FROM peralatan 
WHERE Peralatan like %s
ORDER BY Jenis ASC",
GetSQLValueString("%" .$Search. "%", "text"));
}else{
$query_rcd_Inventory = "SELECT Id, Peralatan, Jenis, Pengeluar, Model FROM peralatan ORDER BY Jenis ASC";
}
