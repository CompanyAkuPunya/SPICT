...
$colname_rcd_Damages = "-1";
if (isset($_GET['Id'])) {
  $colname_rcd_Damages = $_GET['Id'];
}
mysql_select_db($database_dataconn, $dataconn);
$query_rcd_Damages = sprintf("SELECT * FROM jeniskerosakan WHERE Id = %s", GetSQLValueString($colname_rcd_Damages, "int"));
$rcd_Damages = mysql_query($query_rcd_Damages, $dataconn) or die(mysql_error());
$row_rcd_Damages = mysql_fetch_assoc($rcd_Damages);
$totalRows_rcd_Damages = mysql_num_rows($rcd_Damages);
?>
          ...
          <table width="50%" border="0" align="center">
            ...
            <td><table width="100%" align="center" id="formtable">
              ...
              <tr>
                ...
                <th colspan="3" scope="col">TAMBAH JENIS KEROSAKAN</th>
              ...
              <tr>
                <th colspan="3" scope="col"><input name="Id" type="hidden" id="Id" value="<?php echo $row_rcd_Damages['Id']; ?>" /></th>
                </tr>
              <tr>
                <td><strong>Jenis Kerosakan</strong></td>
                <td><strong>:</strong></td>
                <td><span id="sprytextarea1">
                  <textarea name="Keterangan" id="Keterangan" class="text"><?php echo $row_rcd_Damages['Keterangan']; ?></textarea>
                  <span class="textareaRequiredMsg">Sila Masukkan Jenis Kerosakan</span></span></td>
                </tr>
              <tr>
              ...
              <tr>
            	...
            	<input type="button" name="bck_bttn" id="bck_bttn" value="Back" class="button" onclick="parent.location='JenisKerosakanMain.php'"/></td>
                </tr>
            </table>
          </form>
        <br /><br />
