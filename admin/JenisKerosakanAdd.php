...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO jeniskerosakan (Keterangan) VALUES (%s)",
                       GetSQLValueString($_POST['Keterangan'], "text"));

  mysql_select_db($database_dataconn, $dataconn);
  $Result1 = mysql_query($insertSQL, $dataconn) or die(mysql_error());

  $insertGoTo = "/spict/admin/JenisKerosakanMain.php";
  if (isset($_SERVER['QUERY_STRING'])) {
            ...
            <td><table width="100%" align="center" id="formtable">
              ...
              <tr>
                ...
                <td><span id="sprytextarea1">
                  <textarea name="Keterangan" id="Keterangan" class="text"></textarea>
