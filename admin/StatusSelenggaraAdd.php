...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO statusselenggara (Keterangan) VALUES (%s)",
                       GetSQLValueString($_POST['Status'], "text"));

  mysql_select_db($database_dataconn, $dataconn);
  $Result1 = mysql_query($insertSQL, $dataconn) or die(mysql_error());

  $insertGoTo = "/spict/admin/StatusSelenggaraMain.php";
  if (isset($_SERVER['QUERY_STRING'])) {
          ...
          <table width="50%" border="0" align="center">
            ...
            <td><table width="100%" align="center" id="formtable">
              ...
              <tr>
                ...
                <th colspan="3" scope="col">TAMBAH STATUS SELENGGARA</th>
              ...
              <tr>
                <td><strong>Status Selenggara</strong></td>
                <td><strong>:</strong></td>
                <td><span id="sprytextarea1">
                  <textarea name="Status" id="Status" class="text"></textarea>
