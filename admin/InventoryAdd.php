...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO peralatan (Peralatan, Jenis, NoSiri, Pengeluar, Model, Spesifikasi, Kaedah, TahunBeli, DeskripsiProjek, MulaSewa, TamatSewa, IdStaf, IdSyarikat) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "../admin/InventoryMain.php";
  if (isset($_SERVER['QUERY_STRING'])) {
        ...
        <br /><br />
          ...
          <table width="50%" border="0" align="center">
            ...
            <td><table width="100%" align="center" id="formtable">
              ...
              <tr>
                <th width="3%" rowspan="18" scope="col" class="cenlef">&nbsp;</th>
                <th colspan="3" scope="col">TAMBAH PERALATAN</th>
                <th width="3%" rowspan="18" scope="col" class="cenrig">&nbsp;</th>
                </tr>
              <tr>
              ...
              <tr>
                ...
                <td><span id="sprytextfield1">
                  <input type="text" name="Peralatan" id="Peralatan" class="text" />
              ...
              <tr>
                ...
                <td><span id="sprytextfield2">
                  <input type="text" name="NoSiri" id="NoSiri" class="text" />
                  <br /><span class="textfieldRequiredMsg">Sila Masukkan No Siri</span></span></td>
                </tr>
              <tr>
                <td><strong>Pengeluar</strong></td>
                <td><strong>:</strong></td>
                <td><span id="sprytextfield3">
                  <input type="text" name="Pengeluar" id="Pengeluar" class="text" />
              ...
              <tr>
                ...
                <td><span id="sprytextfield4">
                  <input type="text" name="Model" id="Model" class="text"/>
              ...
              <tr>
                ...
                <td><span id="sprytextarea1">
                  <textarea name="Spesifikasi" id="Spesifikasi" class="text"></textarea>
                  <span class="textareaRequiredMsg">Sila Masukkan Spesifikasi</span></span></td>
                </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
                </tr>
              ...
              <tr>
                <td><strong>Tahun Beli / Projek</strong></td>
                <td><strong>:</strong></td>
                <td><input type="text" name="TahunBeli" id="TahunBeli" class="text" disabled="disabled" /></td>
                </tr>
              <tr>
              ...
              <tr>
                ...
                <td>:</td>
                <td><input type="text" name="MulaSewa" id="MulaSewa" class="text" disabled="disabled" /></td>
                </tr>
              <tr>
                <td><strong>Tamat Sewa</strong></td>
                <td>:</td>
                <td><input type="text" name="TamatSewa" id="TamatSewa" class="text" disabled="disabled" /></td>
                </tr>
             <tr>
              ...
              <tr>
                ...
                <td><span id="spryselect2">
                  <label>
                    <select name="IdStaf">
                      <option value="-1">Sila Pilih Staf</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_rcd_Staff['Id']?>"><?php echo $row_rcd_Staff['Nama']?></option>
                      <?php
...
?>
                  ...
                  <br /><span class="selectInvalidMsg">Sila Pilih Staf</span>
                  <span class="selectRequiredMsg">Sila Pilih Staf</span></span></td>
                </tr>
              <tr>
                ...
                <td><span id="spryselect3">
                  <label>
                    <select name="IdSyarikat">
                      <option value="-1">Sila Pilih Syarikat Selenggara</option>
                      <?php
do {  
?>
                      <option value="<?php echo $row_rcd_Company['Id']?>"><?php echo $row_rcd_Company['Nama']?></option>
                      <?php
...
?>
              ...
              <tr>
                <td align="center"><input type="hidden" name="MM_insert" value="form1" />
            	<input type="submit" name="add" id="add" value="Add" width="100" class="button" />
