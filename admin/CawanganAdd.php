...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cawangan (Negeri, Kod, Keterangan) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "/spict/admin/CawanganMain.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
<script src="/spict/SpryAssets/SpryValidationTextField.js" type="text/javascript"></script>
...
<link href="/spict/SpryAssets/SpryValidationTextField.css" rel="stylesheet" type="text/css" />
<!-- InstanceEndEditable -->
          ...
          <table width="50%" border="0" align="center">
            ...
            <td><table width="100%" align="center" id="formtable">
              ...
              <tr>
                ...
                <th colspan="3" scope="col">TAMBAH CAWANGAN</th>
...
?>
              ...
              <tr>
                ...
                <td><span id="sprytextfield1">
                  <input type="text" name="Kod" id="Kod" class="text" /><br/>
              ...
              <tr>
                ...
                <td><span id="sprytextfield2">
                  <input type="text" name="Keterangan" id="Keterangan" class="text" /><br/>
              ...
              <tr>
                <td align="center"><input type="submit" name="add" id="add" value="Add" width="100" class="button" />
