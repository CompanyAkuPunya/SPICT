...
<table width="20%" border="0" cellpadding="1" align="center">
    <tr>
    <td align="center" width="25%"><a href="<?php printf("%s?pageNum_rcd_Company=%d%s", $currentPage, 0, $queryString_rcd_Company); ?>"><img src=	"../images/paging_far_left.png" name="first" width="24" height="24" border="0" id="first" /></a></td>
    <td align="center" width="25%"><a href="<?php printf("%s?pageNum_rcd_Company=%d%s", $currentPage, max(0, $pageNum_rcd_Company - 1), $queryString_rcd_Company); ?>"><img src="../images/paging_left.png" name="previous" width="24" height="24" border="0" id="previous" /></a></td>
    <td align="center" width="25%"><a href="<?php printf("%s?pageNum_rcd_Company=%d%s", $currentPage, min($totalPages_rcd_Company, $pageNum_rcd_Company + 1), $queryString_rcd_Company); ?>"><img src="../images/paging_right.png" name="next" width="24" height="24" border="0" id="next" /></a></td>
    <td align="center" width="25%"><a href="<?php printf("%s?pageNum_rcd_Company=%d%s", $currentPage, $totalPages_rcd_Company, $queryString_rcd_Company); ?>"><img src="../images/paging_far_right.png" alt="" name="last" width="24" height="24" border="0" id="last" /></a></td>
    </tr>
</table>
<br /><br />
          </form>
