...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO syarikat (Nama, Alamat, NoTel, Email, Contact1_Nama, Contact1_NoTel, Contact1_NoHp, Contact1_Email, Contact2_Nama, Contact2_NoTel, Contact2_NoHp, Contact2_Email, Contact3_Nama, Contact3_NoTel, Contact3_NoHp, Contact3_Email) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
          ...
          <form action="<?php echo $editFormAction; ?>" id="form1" name="form1" method="POST">
            ...
            <td><table width="100%" align="center" id="formtable">
              ...
              <tr>
                ...
                <th colspan="3" scope="col">TAMBAH SYARIKAT SELENGGARA</th>
                <th width="3%" rowspan="23" scope="col">&nbsp;</th>
                </tr>
              <tr>
              ...
              <tr>
                ...
                <td><span id="sprytextfield1">
                    <input type="text" name="Nama" id="Nama" class="text" /><br/>
              ...
              <tr>
                ...
                <td><span id="sprytextarea1">
                    <textarea name="Alamat" id="Alamat" width="250"></textarea>
              ...
              <tr>
                ...
                <td><span id="sprytextfield2">
                    <input type="text" name="NoTel" id="NoTel" class="text" /><br/>
                  <span class="textfieldRequiredMsg">Sila Masukkan No Tel</span></span></td>
                </tr>
              <tr>
                <td>Email</td>
                <td>:</td>
              ...
              <tr>
                ...
                <td><span id="sprytextfield4">
                    <input type="text" name="Contact1_Nama" id="Contact1_Nama" class="text" /><br/>
                  <span class="textfieldRequiredMsg">Sila Masukkan Nama Contact Person 1</span></span></td>
                </tr>
              <tr>
                <td>No Tel Pejabat</td>
                <td>:</td>
                <td><span id="sprytextfield5">
                    <input type="text" name="Contact1_NoTel" id="Contact1_NoTel" class="text" /><br/>
              ...
              <tr>
                ...
                <td><span id="sprytextfield6">
                    <input type="text" name="Contact1_NoHp" id="Contact1_NoHp" class="text" /><br/>
              ...
              <tr>
                ...
                <td><span id="sprytextfield7">
                    <input type="text" name="Contact1_Email" id="Contact1_Email"  class="text"/><br/>
                  <span class="textfieldRequiredMsg">Sila Masukkan Email</span></span></td>
                </tr>
                <tr>
              ...
              <tr>
                ...
                <td>:</td>
                <td>
                  <input type="text" name="Contact2_Nama" id="Contact2_Nama" class="text"/>
                </td>
                </tr>
              <tr>
                <td>No Tel Pejabat</td>
                <td>:</td>
                <td>
                  <input type="text" name="Contact2_NoTel" id="Contact2_NoTel" class="text" />
                </td>
                </tr>
              <tr>
                <td>No Tel Bimbit</td>
                <td>:</td>
                <td>
                  <input type="text" name="Contact2_NoHp" id="Contact2_NoHp" class="text" />
                </td>
                </tr>
              <tr>
                <td>Email</td>
                <td>:</td>
                <td>
                  <input type="text" name="Contact2_Email" id="Contact2_Email" class="text" />
                </td>
                </tr>
                <tr>
              ...
              <tr>
                ...
                <td>:</td>
                <td>
                  <input type="text" name="Contact3_Nama" id="Contact3_Nama" class="text" />
                </td>
                </tr>
              <tr>
                <td>No Tel Pejabat</td>
                ...
                <td>
                  ...
                  <input type="text" name="Contact3_NoTel" id="Contact3_NoTel" class="text" />
                </td>
                </tr>
              <tr>
                <td>No Tel Bimbit</td>
                <td>:</td>
                <td><input type="text" name="Contact3_NoHp" id="Contact3_NoHp" class="text" /></td>
                </tr>
              <tr>
                <td>Email</td>
                <td>:</td>
                <td>
                  <input type="text" name="Contact3_Email" id="Contact3_Email" class="text" />
                </td>
                </tr>
             <tr>
              ...
              <tr>
                <td align="center">
                  <input type="submit" name="add2" id="add2" value="Add" class="button" />
