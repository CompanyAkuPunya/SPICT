             ...
             <tr>
              ...
              <tr>
                ...
                <td><span id="spryselect2">
                  <select name="IdStaf" id="IdStaf">
                    <option value="-1" <?php if (!(strcmp(-1, $row_rcd_EditInventory['IdStaf']))) {echo "selected=\"selected\"";} ?>>Sila Pilih Staf</option>
                    <?php
do {  
?>
                    <option value="<?php echo $row_rcd_Staff['Id']?>"<?php if (!(strcmp($row_rcd_Staff['Id'], $row_rcd_EditInventory['IdStaf']))) {echo "selected=\"selected\"";} ?>><?php echo $row_rcd_Staff['Nama']?></option>
                    <?php
